...
async def on_message(message):
    ...
    if message.content.startswith('!welcome'):
        ...
        embed.add_field(name="📎 リンク", value="[GitHub Organization](https://github.com/yudejp), [Twitter](https://twitter.com/yudejp), [LINE オープンチャット](https://line.me/ti/g2/mi36ZEsJkIo9BLqYg1sQFg)", inline=False)
