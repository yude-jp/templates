...
async def on_message(message):
    ...
    if message.content.startswith('!welcome'):
        ...
        embed.add_field(name="📎 リンク", value="[GitHub Organization](https://github.com/yudemoe), [Twitter](https://twitter.com/yude_jp), [LINE オープンチャット](https://line.me/ti/g2/mi36ZEsJkIo9BLqYg1sQFg)", inline=False)
